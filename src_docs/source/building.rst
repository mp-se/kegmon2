...
PCB for scale bases to easier connect all the cables together.
...
My scale bases are found in a separate reporitory : 
...
Mount and solder the temperature sensor on the scale base PCB as indicated by the silkscreen. Mark 
the load cells acording to this schematic and solder the cables in the position indicated on the PCB, 
